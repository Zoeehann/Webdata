...
# 注：由于gemma:2b生成SPARQL质量不稳定，我们用模板匹配替代generate_sparql
...
# 注：answer_with_sparql_generation依赖generate_sparql，由于gemma:2b质量不稳定
# 我们新增answer_with_template作为替代，使用模板匹配+LLM分类的方式
